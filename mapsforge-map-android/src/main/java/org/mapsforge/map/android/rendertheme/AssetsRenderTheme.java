 ...
 */
public class AssetsRenderTheme implements XmlRenderTheme, XmlRenderThemeMenuCallback {
  	...
  	public AssetsRenderTheme(Context context, String relativePathPrefix, String fileName, List<String> themes) throws IOException {
  	...
  	public Set<String> getCategories(XmlRenderThemeStyleMenu style) {
  	  	XmlRenderThemeStyleLayer baseLayer = style.getLayer(style.getDefaultValue());
  	  	Set<String> result = baseLayer.getCategories();
  	  	for (XmlRenderThemeStyleLayer overlay : baseLayer.getOverlays())
  	  	{
  	  	  	if (themes.contains(overlay.getId()))
  	  	  	{
