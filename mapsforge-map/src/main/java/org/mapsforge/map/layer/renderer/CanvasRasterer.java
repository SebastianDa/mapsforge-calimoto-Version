...
public class CanvasRasterer {
  	...
  	void drawMapElements(Set<MapElementContainer> elements, Tile tile, double degreeRad) {
  	  	...
  	  	for (MapElementContainer element : elementsAsList) {
  	  	  	...
  	  	  	element.draw(canvas, tile.getOrigin(), this.symbolMatrix, Filter.NONE, degreeRad);
  	  	}
  	}
