...
public class Circle extends Layer {
  	...
  	public synchronized void draw(BoundingBox boundingBox, byte zoomLevel, Canvas canvas, Point topLeftPoint, double degreeRad) {
  	  	...
  	  	if (!canvasRectangle.intersectsCircle(point.x, point.y, radiusInPixel)) {
  	  	  	return;
  	  	}
  	  	...
  	  	if (this.paintStroke != null) {
  	  	  	...
  	  	  	canvas.drawCircle((int) point.x, (int) point.y, radiusInPixel, this.paintStroke);
  	  	}
  	  	if (this.paintFill != null) {
  	  	  	if (this.keepAligned) {
  	  	  	  	this.paintFill.setBitmapShaderShift(topLeftPoint);
  	  	  	}
  	  	  	canvas.drawCircle((int) point.x, (int) point.y, radiusInPixel, this.paintFill);
  	  	}
  	}
